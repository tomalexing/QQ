            ...
            <div className="quiz-cart__social">
                <ul className="quiz-cart__social-in">
                    <li className="quiz-social__btn quiz-social__btn-fb">
                        <a target="_blank" href={"https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(this.url)}>
                  ...
                  <div className="mdl-dialog__content">
                    <div className="quiz-dialog__cart__social">
                        <ul className="quiz-dialog__cart__social-in">
                            ...
                            <li className="quiz-dialog__social__btn ">
                                <a href={'https://www.reddit.com/submit?url=' + encodeURIComponent(this.url)}>
                                      <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 474.888 474.888" style={{enableBackground: 'new 0 0 474.888 474.888'}} >
